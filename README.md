...
## 🎯 挑战目标 (The Goal)
**三年内，100 个库，从 "Hello World" 到 "Production Ready"。**
记录我的技术栈扩张之路：从 Minecraft 服务端开发，到 AI4Science 科研，再到 Web 全栈。

---

## 🗂️ 库清单 (Library List)

### ☕ Java & Spigot Ecosystem
*我的老本行：服务端插件开发、性能优化与高并发处理。*

| # | Project | Tech Stack / Libs Used | Category | Description | Status |
|:-:|:-------:|:----------------------:|:--------:|:-----------:|:------:|
| 1 | [XiRepeatTask](https://github.com/XiNian-dada/XiRepeatTask) | `BukkitRunnable` | Plugin | 基于Spigot的服务器定时任务插件。 | - |
| 4 | [XiWorldProtect](https://github.com/XiNian-dada/XiWorldProtection) | `Listener API` | Plugin | 世界保护插件。 | Private |
| 5 | [XiWeather](https://github.com/XiNian-dada/XiWeather) | `World API` | Plugin | 天气控制插件。 | - |
...
| # | Project | Tech Stack / Libs Used | Category | Description | Status |
|:-:|:-------:|:----------------------:|:--------:|:-----------:|:------:|
| 2 | [Hairosky](https://github.com/XiNian-dada/Hairuosky) | `Markdown`, `GitBook` | Docs | MC 开服手册。 | - |
